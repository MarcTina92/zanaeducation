...
def get_context(context):
    # Only allow /student-portal to execute this logic
...
def student_dashboard(context, user):
    ...
    fees = frappe.get_all("Fees", filters={"student": student.name}, fields=["outstanding_amount", "posting_date"], order_by="posting_date desc")
    if fees:
        context.fee_status = {
